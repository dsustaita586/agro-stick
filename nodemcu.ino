...
const char* mqtt_server = "192.168.1.120";   // Red local (ifconfig en terminal) -> broker MQTT
IPAddress server(192,168,1,120);             // Red local (ifconfig en terminal) -> broker MQTT
